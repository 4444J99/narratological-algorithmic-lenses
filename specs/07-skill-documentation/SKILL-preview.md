...
description: Distill artist/theorist narrative principles into formal, implementable algorithmic frameworks. Use when asked to extract, formalize, or systematize narrative techniques from any storytelling sourceâ€”filmmakers, writers, theorists, game designers, showrunners. Triggers on requests involving narrative principle extraction, story structure analysis, craft methodology formalization, or creating implementable storytelling protocols.
---
...
- Film â†’ Television (serialization, episode structure)
- Literature â†’ Interactive (agency, branching)
- Single creator â†’ Collaborative (writers' room dynamics)
- Western â†’ Non-Western theoretical traditions

## Reference Files

- **[references/output-template.md](references/output-template.md)** â€” Full document structure template
- **[references/formalization-patterns.md](references/formalization-patterns.md)** â€” Examples of converting prose to algorithms
- **[references/theoretical-correspondences.md](references/theoretical-correspondences.md)** â€” Mapping table across narrative traditions
